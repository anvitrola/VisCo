  ...
  return (
    <Container className="animeLeft">
      ...
      <TextDiv
        ...
        text={
          "If you are familiar with web development and want to make a contribution with this project, feel free to access it's repository clicking in the image aside and open a pull request (just tag me as a reviewer). If you're not from the area but still have any good idea you can just get in touch with me via LinkedIn - in this case just click in my nickname in the footer!"
        }
      />
